...
public class CAnswerFilterContext{
	...
	*/
	...
	/** 
	* @Title: GetRank 
	* @Description: get rank user defined
	* @return   
	*/
	
	public int GetRank() {
		return (this.SentenceReport.SelectedRank);
	}
	
	/** 
	* @Title: GetAlwaysAddNoDateAnswers 
	* @Description: get AlwaysAddNoDateAnswers parameter user defined
	* @return   
	*/
	
	public boolean GetAlwaysAddNoDateAnswers() {
		return (this.SentenceReport.AlwaysAddNoDateAnswers);
	}
	
	/** 
	* @Title: OnlyLatestOneByTimeFilter 
	* @Description: get OnlyLatestOneByTimeFilter parameter user defined
	* @return   
	*/
	
	public boolean GetOnlyLatestOneByTimeFilter() {
		return (this.SentenceReport.OnlyLatestOneByTimeFilter);
	}
