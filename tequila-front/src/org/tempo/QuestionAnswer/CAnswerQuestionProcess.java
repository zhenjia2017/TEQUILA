...
public class CAnswerQuestionProcess extends CNodeProcessorBase<CSentenceAnalysisReport>{
	...
	public CAnswerQuestionProcess(String service, boolean RemoveDateTag, boolean AlwaysAddNoDateAnswers, boolean OnlyLatestOneByTimeFilter, int SelectedRank, INodeProcessor<CSentenceAnalysisReport> next){
		super(next);	
